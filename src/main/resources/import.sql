...
insert into repair ( repair_date, cost, description, status, type, vehicle_id) VALUES ('2017-10-22','100', 'This is a description1', '0', false, '1');
insert into repair ( repair_date, cost, description, status, type, vehicle_id) VALUES ('2017-10-22','100', 'This is a description2', '1',  true, '2');
insert into repair ( repair_date, cost, description, status, type, vehicle_id) VALUES ('2017-10-22','100', 'This is a description3', '2',  false, '3');
insert into repair ( repair_date, cost, description, status, type, vehicle_id) VALUES ('2017-10-22','100', 'This is a description4', '0',  true, '4');
